	...
	<form action="EmployeeController" method="GET" onsubmit="return validateForm()">
		<div class="mb-3">
			<label for="name" class="form-label">Name:</label> <input type="text"
				id="name" name="name" class="form-control" style="width: 400px;" required>
		</div>

		<div class="mb-3">
			<label for="email" class="form-label">Email:</label> <input
				type="email" id="email" name="email" class="form-control" style="width: 400px;" required>
		</div>


		<div class="mb-3">
			<label for="dob">Date of Birth:</label> <input type="date" id="dob"
				name="dob" class="form-control" style="width: 150px;" required
		...
		<div class="mb-3">
			<label for="designation" class="form-label">DESIGNATION:</label> <select
				id="designation" name="designation" class="form-select" style="width: 300px;" required>
